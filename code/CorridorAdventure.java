...
public class CorridorAdventure extends Application {
    ...
    private final String IMAGE_PATH = "C:\\Java_project\\Images"; // folder for images (unchanged)
    private final String SOUND_PATH = "C:\\Java_project\\Sound"; // folder for sounds (as requested)
